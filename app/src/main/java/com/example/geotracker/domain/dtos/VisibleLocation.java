...
public class VisibleLocation {
    ...
    public VisibleLocation(long identifier, double latitude, double longitude, String recordedAtIso) {
    ...
    public static long getGenerateNewIdentifier() {
        return GENERATE_NEW_IDENTIFIER;
    }
    ...
    public boolean equals(Object o) {
        ...
        VisibleLocation that = (VisibleLocation) o;
